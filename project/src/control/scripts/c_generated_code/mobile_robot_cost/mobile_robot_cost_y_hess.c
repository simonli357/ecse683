...
/* mobile_robot_cost_y_hess:(i0[3],i1[2],i2[],i3[7],i4[],i5[2])->(o0[5x5,0nz]) */
...
CASADI_SYMBOL_EXPORT int mobile_robot_cost_y_hess_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
